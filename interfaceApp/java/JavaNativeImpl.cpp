 ...
 */
JNIEXPORT jint JNICALL
JNI_FUNCTION(groupsSyncSibling)(JNIEnv* env, jclass clazz, jstring deviceId)
{
    (void)clazz;
    ...
    return zinaAppInterface->groupsSyncSibling(device);
}
 ...
 */
JNIEXPORT jint JNICALL
JNI_FUNCTION(groupSyncSibling)(JNIEnv* env, jclass clazz, jstring groupId, jstring deviceId)
{
    (void)clazz;
    ...
    if (deviceId == nullptr || groupId == nullptr)
        return ILLEGAL_ARGUMENT;
    ...
    return zinaAppInterface->groupSyncSibling(group, device);
}
...
JNI_FUNCTION(requestGroupsSync)(JNIEnv* env, jclass clazz)
{
    ...
    return zinaAppInterface->requestGroupsSync();
}
